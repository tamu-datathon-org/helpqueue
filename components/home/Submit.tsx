...
export default function Submit(props: { user: User; ticket: Ticket }) {
  ...
  const challengeOptions = ['Challenge A', 'Challenge B', 'Challenge C', 'Miscellaneous'];
  ...
  async function submitTicket() {
    const challenge = document.getElementById('challenge') as HTMLInputElement;
    ...
    if (!challengeValue || !issueValue || !locationValue || !contactValue) {
    ...
    return (
      <div className="p-8 bg-white border border-gray-100 shadow-md rounded-xl md:w-[90vw] lg:w-[35vw] 2xl:w-[500px]">
        ...
        <p className="text-md text-gray-600">
          ...
          !data.user.ticket.claimantId.startsWith('TEMP_')
  ...
  return (
    <div className="p-8 bg-white border border-gray-100 shadow-md rounded-xl md:w-[90vw] lg:w-[35vw] 2xl:w-[500px]">
      ...
      <p className="mt-3 text-md text-gray-600">Challenge</p>
      <Select
        id="challenge"
        className="mt-2"
        variant="outline"
