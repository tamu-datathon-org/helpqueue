...
export default function Submit(props : {
  ...
  if (data.user.ticket) {
    return (<div className="p-8 bg-white border border-gray-100 shadow-md rounded-xl md:w-[90vw] lg:w-[35vw] 2xl:w-[500px]">
      ...
      <button onClick={() => cancelTicket()} className="w-full mt-8 py-4 px-8 text-white font-bold bg-red-500 rounded-xl">
        Cancel Ticket
      </button>
    </div>);
  }
  ...
  return (<div className="p-8 bg-white border border-gray-100 shadow-md rounded-xl md:w-[90vw] lg:w-[35vw] 2xl:w-[500px]">
    ...
    <Input id="issue" className="mt-2" variant="outline" placeholder="Issue"/>
    <p className="mt-3 text-md text-gray-600">
      Location (so we can find you!)
    </p>
    <Input id="location" className="mt-2" variant="outline" placeholder="Location"/>
    <p className="mt-3 text-md text-gray-600">
      Contact (if we can&apos;t find you!)
    </p>
    <Input id="contact" className="mt-2" variant="outline" placeholder="Contact"/>
    <button onClick={() => submitTicket()} className="w-full mt-8 py-4 px-8 text-white font-bold bg-blue-500 rounded-xl">
      Submit Ticket
    </button>
  </div>);
}
