...
export default function ClaimButton(props : {
    ...
    return (<div className="flex justify-between items-center mt-6">
      ...
      <a className={`${
        claimLoading
          ...
          : "bg-blue-500 border-blue-500"} w-7/12 text-center py-2  border-2 rounded-lg text-md font-bold text-white cursor-pointer`} onClick={() => ticketAction("resolve")}>
        Resolve
      </a>
      <a className={`${
        claimLoading
          ? "text-gray-400 border-gray-400"
          : "border-red-400 text-red-400"} w-1/3 text-center py-2 border-2  rounded-lg text-md font-bold  cursor-pointer`} onClick={() => ticketAction("unclaim")}>
        Unclaim
      </a>
    </div>);
  }
  ...
  return (<div className="flex justify-center mt-6 cursor-pointer">
    <p className={`${
      unclaimLoading
        ? "bg-gray-400 border-gray-400"
        : "bg-blue-500 border-blue-500"} w-full text-center py-2 border-2 rounded-lg text-md font-bold text-white`} onClick={() => ticketAction("claim")}>
      Claim Ticket
    </p>
  </div>);
}
